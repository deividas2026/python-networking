...
def build_word_packet(word_count):
    ...
    custom_word = "a" * (2**16 - 1)
    custom_word_bytes = custom_word.encode()
    custom_word_len = len(custom_word)
    custom_word_len_bytes = custom_word_len.to_bytes(2, "big")
    custom_word_packet = custom_word_len_bytes + custom_word_bytes
    #word_packet += custom_word_packet
